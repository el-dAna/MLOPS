...
import pytest
import example
from unittest.mock import patch #needed for mock tests in cases of geting data from url where the test is not dependent on the status of the site, we are interested in code executing correctly
